    ...
    <div className={css.product_list}>
      {
        ...
        toJS(products.products).map((product, index) => (
          <ListItem onClick={() => handlerActiveProduct(product)} key={index} _id={product._id} name={product.name} price={product.price} image={product.image} description={product.description} info={product.info} pattern={product.pattern}/>
        ))
      }
